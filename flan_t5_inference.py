"""
Flan-T5 Inference Script for Financial Regulation Q&A
...
class FlanT5FinancialInference:
    """Flan-T5 inference for financial Q&A"""
    ...
    def load_model(self):
        ...
        logger.info(f"Loading Flan-T5 model from: {self.finetuned_model_path}")
    ...
    def create_input_prompt(self, question: str) -> str:
        """Create proper input prompt for Flan-T5"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Flan-T5 Financial Regulation Q&A")
    parser.add_argument("--model_path", type=str, default="flan_t5_financial_model")
    parser.add_argument("--base_model", type=str, default="google/flan-t5-small")
    ...
    try:
        inference_engine = FlanT5FinancialInference(
    ...
    if args.question:
        ...
        print("\n" + "="*60)
        print("FLAN-T5 MODEL DEMO RESULTS")
        print("="*60)
        ...
        # Save results
        with open("flan_t5_demo_results.json", 'w', encoding='utf-8') as f:
            json.dump(results, f, indent=2, ensure_ascii=False)
        print(f"\nResults saved to: flan_t5_demo_results.json")
